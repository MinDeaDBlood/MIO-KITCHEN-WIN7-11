...
class updaterutil:
    ...
    def generate(self, author: str, version: str, partitions):  # This part code from @libchara-dev
...
class portutils:
    def __init__(self, items, bootimg: str, sysimg: str, portzip: str, genimg: bool = False):
        self.items = items
        self.sysimg = sysimg
